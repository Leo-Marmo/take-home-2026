...
async def responses(
    ...
    **kwargs,
    ...
    """
    Call OpenRouter with automatic token usage logging.

    Pass a Pydantic class as text_format to get structured output parsed and
    validated automatically; omit it for a raw response object.
    """
    client = _get_client()
